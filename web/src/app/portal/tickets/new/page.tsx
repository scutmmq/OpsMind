...
export default function TicketSubmitPage() {
  ...
  return (
    <div className={styles.wrapper}>
      <h1 className={styles.title}>提交申告</h1>
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.formRow}>
          <div className={styles.formCol}>
            ...
            <select value={urgency} onChange={(e) => setUrgency(Number(e.target.value))} className={styles.select}>
          ...
          <div className={styles.formCol}>
            <label className={styles.label}>影响范围</label>
            <select value={impactScope} onChange={(e) => setImpactScope(Number(e.target.value))} className={styles.select}>
