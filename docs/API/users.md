...
> **Base URL:** `/api/v1/admin/users` | **Auth:** JWT + `user:manage`
...
| code | HTTP | 说明 |
|------|------|------|
| 10003 | 400 | 参数校验失败（real_name/phone 未提供） |
| 10004 | 404 | 用户不存在 |
...
|------|------|------|
| 10003 | 400 | 不能冻结自己的账号 |
| 10003 | 400 | 不能冻结/移除最后一个系统管理员 |
| 10004 | 404 | 用户不存在 |
| 10006 | 400 | 用户已被冻结（重复冻结） |
...
| code | HTTP | 说明 |
|------|------|------|
| 10003 | 400 | 参数校验失败 / 不能删除自己 / 不能删除最后一个管理员 |
